...
import { FaBed, FaBath, FaMapMarker, FaCheck, FaRulerCombined } from 'react-icons/fa';
              ...
              <div className="flex flex-col md:flex-row justify-around">
                ...
                >
                  ...
                  <div className="text-2xl font-bold text-blue-500">
                    { property.rates.nightly ? `$${property.rates.nightly.toLocaleString()}/night` : (
                ...
                >
                  ...
                  <div className="text-2xl font-bold text-blue-500">
                  { property.rates.weekly ? `$${property.rates.weekly.toLocaleString()}/wk` : (
                ...
                <div className="flex items-center justify-center mb-4 pb-4 md:pb-0">
                  ...
                  <div className="text-2xl font-bold text-blue-500">
                  { property.rates.monthly ? `$${property.rates.monthly.toLocaleString()}/mo` : (
                     <FaTimes className="text-red-700" />
                  ) }
                  </div>
                </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md mt-6">
              ...
              >
                {property.amenities.map((amenity, index) => (
                  <li
                    key={index}
                    className="text-gray-800 mb-2 flex align-middle justify-center md:justify-start"
                  >
